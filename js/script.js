...
async function loadData() {
    try {
        // Menghapus baris fetch experience.json agar tidak membebani performa
        const [profileData, educationData, projectsData] = await Promise.all([
        ...
        renderProjects(projectsData); // Fungsi renderExperience dihapus dari sini
...
function renderProfile(data) {
    ...
    // Bagian render CV otomatis (if data.cv) DIHAPUS dari sini agar tidak error
}
...
function renderEducation(data) {
    ...
    data.forEach(edu => {
        ...
        // Ditambahkan edu.university || edu.School agar nama sekolah SMA kamu tetap muncul
        eduItem.innerHTML = `
            <div class="edu-header">
                ${edu.logo ? `<img src="${edu.logo}" alt="${edu.university || edu.School} logo" class="edu-logo">` : ''}
                <div>
...
// Fungsi renderExperience(data) SELESAI DIHAPUS sepenuhnya dari sini
